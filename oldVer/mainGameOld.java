...
public class mainGameOld extends JFrame implements ActionListener {
    ...
    mainGameOld() {
        ...
        nameplate.setIcon(new ImageIcon("nameplates\\wood.png"));
        this.add(nameplate);
        ...
        nameplate2.setIcon(new ImageIcon("nameplates\\wood.png"));
        this.add(nameplate2);
        ...
        board = new ImageIcon("boards\\wood.png");
    ...
    public void proceed() {
        ...
        // CHECKS IF ONE OF THEM HAS NO MORE LIVES
        if (player.getLives() == 0) {
    ...
    public static void main(String[] args) {
        ...
        mainGameOld mainGame = new mainGameOld();
